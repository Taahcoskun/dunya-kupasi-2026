...
import { UserPlus, User, Lock, AlertCircle, ArrowRight } from "lucide-react";
      ...
      <div className="max-w-md w-full">
        <div className="glass-dark rounded-[2.5rem] p-8 shadow-2xl border border-white/5 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl font-black mb-2 text-center text-white tracking-tight">Hesap <span className="text-gradient">Oluştur</span></h2>
            <p className="text-gray-400 text-center mb-8">Tahmin yarışmasına bugün katılın</p>
            ...
            <div className="mt-8 pt-6 border-t border-white/5 text-center">
              <p className="text-gray-400">
                Zaten hesabınız var mı? <Link href="/login" className="text-blue-400 font-bold hover:text-blue-300 transition-colors underline-offset-4 hover:underline">Giriş Yap</Link>
              </p>
            </div>
          </div>
        </div>
