  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="flex flex-col items-center mb-12">
        ...
        {isAdmin && (
          <div className="mt-4 bg-red-500/10 text-red-500 px-4 py-1 rounded-full text-xs font-black border border-red-500/20 tracking-widest uppercase">
                  ...
                  <div key={team.id} className="flex items-center gap-3 p-2 rounded-xl hover:bg-white/5 transition-colors group">
                    ...
                    {editingId === team.id ? (
                      ...
                      <div className="flex gap-3 w-24 justify-end text-sm font-bold">
                        <span className="text-gray-500 w-6 text-center">{team.played}</span>
                        <span className="text-gray-500 w-6 text-center">{team.goalDiff}</span>
                        <span className="text-blue-400 w-6 text-center">{team.points}</span>
                      </div>
                    )}
